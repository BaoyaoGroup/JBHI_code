...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False, num_groups=0):
        ...
        self.up1 = Up(1024, 512 // factor, bilinear, num_groups=num_groups)
        self.up2 = Up(512, 256 // factor, bilinear, num_groups=num_groups)
        self.up3 = Up(256, 128 // factor, bilinear, num_groups=num_groups)
        self.up4 = Up(128, 64, bilinear, num_groups=num_groups)
